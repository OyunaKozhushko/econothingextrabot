...
async def cmd_start(message: types.Message):
    ...
    if not res:
        ...
        await message.answer(f"Привет! Рад знакомству, {first_name}" + emoji.get("hug") + "Я бот проекта Ничего лишнего. У меня есть три полезных курса, которые ты можешь пройти вместе со мной. Каждый курс можно пройти только один раз, длительность курса - 2 недели, но ты можешь делать перерыв, когда захочешь. Каждый день я буду присылать задание, в нем будет и полезный материал, и полезное задание" + emoji.get("relaxed_face"))

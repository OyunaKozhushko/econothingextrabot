...
from states import courses_dict
...
async def cmd_start(message: types.Message):
    ...
    if not res:
        ...
        пространства! 
        Второй - Осознанный гардероб. Просто удивительно, как массмаркет изменил наши отношения
        с одеждой. Теперь у нас очень много вещей - и очень мало среди них тех, которые мы носим. Второй курс поможет
        разобраться, какие нужными, а какие нет, как экологично избавиться от ненужного, и как осознанно разобрать свой 
        гардероб
        Третий курс - Цифровой минимализм. Он поможет тебе очистить цифровое пространство вокруг
        себя и тратить меньше времени на такие залипательные вещи, как социальные сети, электронная почта и переписки 
        ни о чем.""")
